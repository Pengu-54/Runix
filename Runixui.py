...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.decompilebutton = QtWidgets.QPushButton(self.widget1)
        self.decompilebutton.setObjectName("DecompileButton")
        self.decompilebutton.setMinimumSize(QtCore.QSize(0,40))
        self.decompilebutton.setText("Decompile")
        self.horizontalLayout.addWidget(self.CompileButton)
        self.horizontalLayout.addWidget(self.decompilebutton)
